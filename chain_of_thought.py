...
# TODO, v2 implement option to use different prompting:
# Ref: Lewkowycz’ 2022 https://arxiv.org/pdf/2206.14858.pdf
# Ref: Section 9.7.6 of the Gemini 1.5 whitepaper: https://arxiv.org/pdf/2403.05530.pdf
...
class ChainOfThought(FewShotBuilder):
    ...
    def extract_answer(self, answer):
        ...
        # But then there are other models insists on outputting english; or other extraneous tokens:
        # The answer is: $n=5$.
