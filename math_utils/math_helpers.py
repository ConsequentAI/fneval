...
def rm_latex_math(expr: str) -> str:
    def wrapped_latex_math(expr: str) -> bool:
        expr = expr.strip()
        return len(expr) >=2 and expr[0] == '$' and expr[-1] == '$'

    expr = expr.strip()
    return expr[1:-1] if wrapped_latex_math(expr) else expr


# The below is a copy of the helper functions in the MATH repo:
# https://github.com/hendrycks/math/blob/main/modeling/eval_math_gpt.py
...
# The below is a copy of the helper functions in the MATH repo:
# https://github.com/hendrycks/math/blob/main/modeling/dataset/util.py
